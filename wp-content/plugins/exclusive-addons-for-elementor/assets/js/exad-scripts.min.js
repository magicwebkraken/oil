(function ($) {
    ...
    var modalWrapper = $scope.find(".exad-modal").eq(0),
      ...
      preventPageScroll = function (modalStatus) {
        const pageBody = exadPageBody[0],
          ...
          calculatedValue =
            Number.parseFloat(
              window.getComputedStyle(pageBody).getPropertyValue(styleProperty)
            ) + scrollbarWidth,
          preventPageScrollval = modalItem.attr(
            "data-exad_modal_prevent_page_scroll"
          );
        if ("yes" === preventPageScrollval) {
          if ("show" === modalStatus) {
            exadPageBody.addClass(cssClass);
            exadPageBody.attr(
              exadSavedPaddingAttr,
              pageBody.style.getPropertyValue(styleProperty)
            );
            exadPageBody.css(
              styleProperty,
          ...
          if ("hide" === modalStatus) {
            ...
            let exad_saved_paddingright_value =
              exadPageBody.attr(exadSavedPaddingAttr);
            exadPageBody.css(styleProperty, "");
            if (
              null !== exad_saved_paddingright_value &&
  ...
  $(window).on("elementor/frontend/init", function () {
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/exad-flipbox.default",
      exclusiveFlipBox
    );
    elementorFrontend.hooks.addAction(
