            ...
            i.each(function () {
              !(function (a, n) {
                ...
                if ((n.markers.push(s), a.html())) {
                  var l = new google.maps.InfoWindow({ content: a.html() });
  ...
  e(window).on("elementor/frontend/init", function () {
      ...
      l = function (e, t) {
        ...
        function c(e) {
          e
            ...
            a.find("input.eae-content-toggle-switch").prop("checked", !!e),
            window.dispatchEvent(new Event("resize"));
        }
    ...
    const c = function (e, t, a = null, n) {
        ...
        if (
          ...
          "yes" == e.scrollbar &&
            (r.scrollbar = { el: d + " .eae-swiper-scrollbar", hide: !0 }),
          (r.thumbs = { swiper: i }),
          ...
          "svg" == t.pop_icon.library
            ? (($close_btn_html = ""),
              ($close_btn_html =
                ...
                m(t.pop_icon.value.url) +
                "); mask-image: url(" +
                m(t.pop_icon.value.url) +
                '); "></svg>'))
            : ($close_btn_html =
                '<i class="eae-close ' + m(t.pop_icon.value) + '"> </i>'),
            e(x).eaePopup({
              type: "inline",
              midClick: !0,
        ...
        if ("slide" == t.coupon_type && "" != t.dynamic_coupon) {
          ...
          if ("yes" == t.preview_modal && elementorFrontend.isEditMode())
            ...
            T.addEventListener("touchstart", (e) => {
              const t = e.touches[0];
              (E = t.clientX - T.getBoundingClientRect().left),
          ...
          if ("yes" == t.preview_modal && elementorFrontend.isEditMode())
            ...
            if (
              (null == t.item_bg_image &&
                ...
                ((w.src = eae.plugin_url + "assets/img/coupon/scratch_img.png"),
                (w.onload = function () {
                  v.drawImage(w, 0, 0, g, h);
                })),
              null != t.item_bg_image)
            )
              (w.src = t.item_bg_image.url),
                (w.onload = function () {
                  v.drawImage(w, 0, 0, g, h);
                });
            else if (
              ...
              if (f) {
                ...
                (u = s),
                  (o = (function (e) {
                    (!e || e < 1) && (e = 1);
                    for (
                      var t = v.getImageData(0, 0, g, h).data,
                        a = t.length,
                        n = a / e,
                        i = 0,
                        r = (i = 0);
            ...
            (y.src = eae.plugin_url + "assets/img/coupon/brush.png"),
              canvas.addEventListener("mousedown", _, !1),
              canvas.addEventListener("touchstart", _, !1),
              canvas.addEventListener("mousemove", k, !1),
              canvas.addEventListener("touchmove", k, !1),
              canvas.addEventListener("mouseup", C, !1),
              canvas.addEventListener("touchend", C, !1);
          }
      },
    ...
    (v = g.extend({
          ...
          (function (t, a, n) {
            const i = t.parentElement.getBoundingClientRect(),
              ...
              l = {
                ...
                "right-top": () => ({ top: 0, left: i.width + e.off_set.size }),
                "right-center": () => ({
                  top: (i.height - r.height) / 2,
        ...
        function (e, a) {
          ...
          const l =
              "icon" === o
                ...
                : `<svg class="eae-close" style="-webkit-mask: url(${s}); mask: url(${s}); -webkit-mask-size: cover; mask-size: cover; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat;"></svg>`,
            ...
            E(n).all > 1 &&
              (a = setInterval(function () {
                ...
                "yes" === p &&
                  ...
                  "yes" === f &&
                    ("yes" === p
                      ? 59 == r.minutes && 59 == r.seconds && D(o[1])
                      : 59 == r.minutes && 59 == r.seconds && D(o[0])),
                  "yes" === u &&
                    ("yes" === p
                      ? "yes" === f
                        ? 59 == r.seconds && D(o[2])
      ...
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/eae-animated-link.default",
        function (e) {
          elementorFrontend.elementsHandler.addHandler(h, { $element: e });
        }
      ),
      elementorFrontend.hooks.addAction(
        "frontend/element_ready/eae-dropbar.default",
        function (e) {
          elementorFrontend.elementsHandler.addHandler(v, { $element: e });
        }
      );
  });
})(jQuery);
